    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "1", 5.9900000000000002, "Sell" });

            migrationBuilder.InsertData(
                table: "TransactionTypes",
                columns: new[] { "TransactionTypeId", "CommissionFee", "Name" },
                values: new object[] { "2", 5.4000000000000004, "Buy" });

            migrationBuilder.InsertData(
                table: "Transactions",
                columns: new[] { "TransactionId", "CompanyName", "Quantity", "SharePrice", "TickerSymbol", "TransactionTypeId" },
                values: new object[] { 1, "Google", 100, 2701.7600000000002, "GOOG", "1" });

            migrationBuilder.InsertData(
                table: "Transactions",
                columns: new[] { "TransactionId", "CompanyName", "Quantity", "SharePrice", "TickerSymbol", "TransactionTypeId" },
                values: new object[] { 2, "Microsoft", 100, 123.45, "MSFT", "2" });
